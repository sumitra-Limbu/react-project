...
function ProductDetail() {
  const [product,setProduct] = useState("")
   ...
   const discount_precent=product.discountPercentage
            ...
            <div className="md:flex-1 px-4">
                ...
                <div className="flex mb-4">
                    ...
                    <div>
                        ...
                        <span className="text-gray-600 dark:text-gray-300">In Stock{product.availabilityStatus}</span>
                    </div>
                </div>
                {/* <div className="mb-4">
                ...
                <div>
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm mt-2">{product.description}
